...
from TransformerModel import load_cmaps_data, inverse_rul_transform, TransformerBlock  # noqa: F401
...
if __name__ == "__main__":
    ...
    # min_sequence_length=1 garante que todos os 100 motores sejam incluídos
    X_test, _, unit_ids = load_cmaps_data(test_path, min_sequence_length=1)

    # Pega apenas a última janela de cada motor — alinha com RUL_FD001.txt
    last_indices = []
