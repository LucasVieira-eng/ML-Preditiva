...
plt.savefig(os.path.join(os.path.dirname(__file__), "../../plots/LSTM_comparison_plot.png"), dpi=100, bbox_inches='tight')
print("Gráfico salvo como LSTM_comparison_plot.png")
plt.close()
...
plt.savefig(os.path.join(os.path.dirname(__file__), "../../plots/LSTM_error.png"), dpi=100, bbox_inches='tight')
print("Gráfico salvo como LSTM_error.png")
plt.close()