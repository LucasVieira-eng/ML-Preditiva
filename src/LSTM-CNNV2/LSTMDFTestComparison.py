...
ax.set_ylabel('RUL')
ax.set_title('CNN-LSTM: RUL Previsto vs Real')
plt.savefig(os.path.join(os.path.dirname(__file__), "../../plots/LSTMV2_comparison_plot.png"), dpi=100, bbox_inches='tight')
print("Gráfico salvo como LSTMV2_comparison_plot.png")
plt.close()
...
ax.set_title("CNN-LSTM: Erro de Predição RUL por Motor")
plt.savefig(os.path.join(os.path.dirname(__file__), "../../plots/LSTMV2_error.png"), dpi=100, bbox_inches='tight')
print("Gráfico salvo como LSTMV2_error.png")
plt.close()